...
\section{The fundamental sequence}
    ...
    \begin{definition}
        The torsion is called a \blue{shaggy torsion} if $\mu \in \pir$. Otherwise, %in case of $\pi$-irrational torsion $\mu \in \pirr$, 
    ...
    \begin{corollary}
        ...
        $$
            ...
            % \rho_t^8 - (2 + \rho_s^2)\rho_t^4 + (4\cos^2(\varphi_s-\varphi_t)-2)\rho_s^2\rho_t^2 - \rho_s^2 + 1 = 0 
        .$$
    \end{corollary}
...
\section{The elemental roots}
    ...
    \begin{theorem}
        ...
        $$ will be an elemental root of merosity $N$ if $$
         ...
         % \exists M :\; \gcd(M,N)=1$ and $$
        % \chi+\varphi_s = \frac{2\pi M}{N}
        $$ and $  \gcd(M,N)=1$.
    \end{theorem}
    \begin{proof}
        \red{Needs to be written.}
