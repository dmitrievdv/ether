...
\section{The fundamental sequence}
    ...
    \end{theorem}
    \begin{proof}
        This is obvious.%, e.g. see the next theorem (Theorem~\ref{th:intbrim}).
    \end{proof}
    ...
    \end{theorem}
    \begin{proof}
        The condition for $s$ to be in the brim (Def. \ref{def:brim}) can be written as 
        \be\label{eq:brim}
